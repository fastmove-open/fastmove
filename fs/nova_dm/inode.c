	...
	u64 *pi_addr, int extendable, int extend_alternate)
{
	...
	for (i = 0; i < superpage_count; i++) {
		...
		if (curr == 0) {
			...
			// FIXME: This is why we need a possible way to allocate
			// FIXME: Instead of the important flag, we can try to
			//        create a new function to allocate seperately
			//        for allocating this inode tablee
